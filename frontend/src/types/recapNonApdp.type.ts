...
export interface RecapNonAPDPListResponse {
  success: boolean;
...
export interface RecapNonAPDPListParams {
  page?: number;
  limit?: number;
...
// Detail
export interface PurchaseOrderDetailNonApdpResponse {
  success: boolean;
  data: PurchaseOrderDetailNonApdp;
  message: string;
  requestId: string;
}

export interface PurchaseOrderDetailNonApdp {
  id: number;
  code: string;
  vendorName: string;
  status: string;
  ...
  items: PurchaseOrderDetailNonApdpItem[];
  grandTotal: number;
  totalItems: number;
}
...
export interface PurchaseOrderDetailNonApdpItem {
  id: number;
