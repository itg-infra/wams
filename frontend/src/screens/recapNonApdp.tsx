...
import { useRecapNonApdpListController } from "../controllers/finance/recapNonApdpController";
import { DataTable, type Column } from "../components/ui/table";
import { PageHeader, lastUpdatedLabel } from "../components/ui/page-header";
import { Button } from "../components/ui/button";
import { Toolbar } from "../components/ui/toolbar";
import type { BudgetPlanListItem } from "../types/recapNonApdp.type";
...
export default function RecapNonApdp() {
  ...
  const {
    ...
    error,
    goToPage,
  } = useRecapNonApdpListController({ page: 1, limit: 10 });
    ...
    <>
      ...
      <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-y-auto">
        ...
        <DataTable
          ...
          tableClassName="min-w-225 text-sm"
