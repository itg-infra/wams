...
public interface IUserRepository
{
    ...
    Task<(User User, UserCompany? Membership)?> GetLoginIdentityAsync(
        string email,
        long companyId,
    ...
    Task<List<long>> GetUserWarehouseIdsAsync(long userId, long? userCompanyId, CancellationToken ct = default);
    ...
    Task<List<User>> GetUsersByRolesAndWarehouseForCompanyAsync(long companyId, long warehouseId, IReadOnlyCollection<string> roleNames, CancellationToken ct = default);
    ...
    Task<List<User>> GetUsersByPermissionAndWarehouseForCompanyAsync(long companyId, long warehouseId, string permissionKey, CancellationToken ct = default);
    ...
    Task<(bool WarehouseExists, bool HasAccess)> CheckWarehouseAccessAsync(long userId, long warehouseId, long? userCompanyId, CancellationToken ct = default);
