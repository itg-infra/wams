...
public interface IUserService
{
    ...
    Task<UserResponse> UpdateAsync(long id, UpdateUserRequest request, long actorUserId, CancellationToken ct = default);
    Task DeleteAsync(long id, CancellationToken ct = default);
    Task DeleteAsync(long id, long actorUserId, CancellationToken ct = default);
    ...
    Task AssignRoleAsync(long userId, AssignRoleRequest request, long actorUserId, CancellationToken ct = default);
    Task RemoveRoleAsync(long userId, long roleId, CancellationToken ct = default);
    Task RemoveRoleAsync(long userId, long roleId, long actorUserId, CancellationToken ct = default);
    Task AssignWarehouseAsync(long userId, AssignWarehouseRequest request, CancellationToken ct = default);
    Task AssignWarehouseAsync(long userId, AssignWarehouseRequest request, long actorUserId, CancellationToken ct = default);
    Task RemoveWarehouseAsync(long userId, long warehouseId, CancellationToken ct = default);
    Task RemoveWarehouseAsync(long userId, long warehouseId, long actorUserId, CancellationToken ct = default);
