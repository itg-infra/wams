...
public class WorkOrderUnloadingItemConfiguration : IEntityTypeConfiguration<WorkOrderUnloadingItem>
{
    public void Configure(EntityTypeBuilder<WorkOrderUnloadingItem> builder)
    {
        builder.ToTable("work_order_unloading_items");
